  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Ink(
        ...
        child: Text(answer, style: TextStyle(color: isSelected? onSurfaceTextColor : null),),
      ),
...
class CorrectAnswer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Ink(
      ...
      child: Text(answer, style: const TextStyle(color: correctAnswerColor,
...
class WrongAnswer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Ink(
      ...
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 20),
      child: Text(answer, style: const TextStyle(color: wrongAnswerColor,
          fontWeight: FontWeight.bold),),
    );
  }
}
...
class NotAnswered extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Ink(
      ...
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 20),
      child: Text(answer, style: const TextStyle(color: notAnsweredColor,
          fontWeight: FontWeight.bold),),
